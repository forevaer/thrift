...
public class Person implements org.apache.thrift.TBase<Person, Person._Fields>, java.io.Serializable, Cloneable, Comparable<Person> {
   ...
   * @see Gender
   */
  public @org.apache.thrift.annotation.Nullable Gender gender; // optional
   ...
   * @see Gender
   */
  public Person setGender(@org.apache.thrift.annotation.Nullable Gender gender) {
    this.gender = gender;
    return this;
  }
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Person struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // GENDER
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.gender = com.godme.thrift.Gender.findByValue(iprot.readI32());
